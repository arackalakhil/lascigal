...
var wc_single_product_params = {
    ...
    function generateCoupon() {
        const responseDiv = document.querySelector(".coupon-response");

        if (coupons.length === 0) {
            responseDiv.innerHTML = "<p>❌ Sorry, all coupons have been claimed!</p>";
            return;
        }
        ...
        // Show coupon
        responseDiv.innerHTML = `<p>🎉 Your Coupon Code: <strong>${coupon}</strong></p>`;
    }