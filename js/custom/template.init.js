...
function lovestory_theme_init_post_formats() {
    ...
    if (LOVESTORY_STORAGE['button_hover'] && LOVESTORY_STORAGE['button_hover'] != 'default') {
        jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				#buddypress a.button:not([class*="sc_button_hover_"])').addClass('sc_button_hover_' + LOVESTORY_STORAGE['button_hover']);
        if (LOVESTORY_STORAGE['button_hover'] != 'arrow')
            jQuery('input[type="submit"]:not([class*="sc_button_hover_"]),\
					...
					.tagcloud > a:not([class*="sc_button_hover_"])').addClass('sc_button_hover_' + LOVESTORY_STORAGE['button_hover']);
    }
